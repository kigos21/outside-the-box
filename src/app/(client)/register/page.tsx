        ...
        <div className="w-full">
          ...
          >
            ...
            <div className="mt-2 flex w-full flex-col items-center gap-4">
              <button
                type="submit"
                className="bg-cs-blue text-cs-cream w-32 rounded-lg px-6 py-4 font-semibold uppercase shadow-md transition-all hover:bg-black hover:text-white hover:shadow-none"
              >
                Register
              </button>
