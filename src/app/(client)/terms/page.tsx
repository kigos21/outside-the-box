  ...
  return (
    <div className="mx-auto flex max-w-screen-lg flex-col gap-2 px-[7%] py-16 pt-28 font-sans xl:px-0">
      ...
      <div className="mt-6">
        ...
        <h2 className="text-2x font-bold underline">Conditions of use</h2>
        <ul>
        ...
        <ul>
          ...
          <ul className="ml-2">
            ...
            <li className="mb-4 text-left text-xl">
              ...
              3. Free Use of 24" Flat Screen TV (upon request) OR Free Use of
        ...
        <ul>
          <li className="mb-4 text-left text-xl">
            ...
            required to confirm the client's reservation. The remaining balance
            is payable on the date of the client's stay.
          </li>
        </ul>
        <h2 className="text-2xl font-bold underline">
          ...
          <li className="mb-4 text-left text-xl">
            ...
            <ul>
              <li className="ml-2 text-xl ">
                a. To register at the front desk, you must first create an
                account on our website. Any person not registered will not be
                permitted to enter the premises.
              </li>
            </ul>
            2. Present any ID (i.e., government, school) to the staff upon
            registration. <br />
            3. Be considerate. Keep voices and noises down to a minimum to avoid
            disturbing other guests.
            <br /> 4. Do not leave your things unattended. Coursescape Coworking
            Space shall not be liable for any loss.
            <br /> 5. A 10-minute grace period is allowed before an additional
            hour is charged to your balance.
            <br /> 6. Maintain a clean and tidy environment for all users to
            enjoy. Any spills, stains, or damage caused to the property will
            result in a penalty fee, as we take the maintenance of our premises
            seriously.
            <br /> 7. Follow the "Clean As You Go" rule: Please clean up after
            yourself and dispose of any waste properly. This helps maintain a
            pleasant environment for all users of the workspace.
          </li>
        </ul>
      </div>
    </div>
