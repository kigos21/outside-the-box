...
export default function Home() {
  return (
    <main>
      ...
      >
        <div className="">
          <h2 className="py-5 text-center text-7xl font-bold">CONTACT US</h2>
      ...
      <div className="flex h-screen items-center justify-center">
        <div className=" text-center">
          <h2 className="py-5 text-7xl font-bold">OPERATIONAL HOURS</h2>

          <div className="ml-72 mr-72 grid grid-cols-2 gap-5">
            <div className="rounded-3xl shadow-md shadow-otb-blue bg-otb-yellow p-2 text-2xl font-bold w-50">
              WEEKDAYS
            </div> 
            <div className="rounded-3xl shadow-md shadow-otb-blue bg-otb-yellow p-2 text-2xl font-bold drop-shadow-md w-50">
              10:00 AM - 5:00 AM
            </div>
            <div className="rounded-3xl shadow-md shadow-otb-blue bg-otb-yellow p-2 text-2xl font-bold drop-shadow-md w-50">
              WEEKENDS
