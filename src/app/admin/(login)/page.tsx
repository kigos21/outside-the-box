...
export default function AdminLogin() {
  ...
  const onSubmit: SubmitHandler<LoginFormBody> = async ({
    ...
    let trimmedUsername = username.trimEnd();
    let trimmedPassword = password.trimEnd();
        ...
        <div className="w-full border-none">
          ...
          >
            ...
            <div className="mt-4 flex flex-col gap-4">
              ...
              <button
                disabled={timeout !== 0}
                className="cursor-pointer rounded-md bg-cs-yellow px-6 py-4 font-semibold uppercase shadow-md transition-all hover:bg-black hover:text-white hover:shadow-none disabled:opacity-10 disabled:hover:bg-cs-yellow disabled:hover:text-black"
              >
                Login
              </button>
